...
/// <summary>
/// Respuesta generada por el asistente financiero. Toda respuesta es un conjunto
/// de bloques (<see cref="ResponseBlockDto"/>) que el frontend renderiza de forma
/// polimórfica; <see cref="Respuesta"/> conserva el texto plano para historial.
/// </summary>
public class AsistenteRespuestaDto
{
	...
	/// <summary>Bloques enriquecidos de la respuesta (texto, gráficos, tablas, tarjetas, sugerencias, acciones).</summary>
	public List<ResponseBlockDto> Bloques { get; set; } = [];
}
