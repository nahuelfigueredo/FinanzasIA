    ...
    public partial class InicialPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categorias",
                columns: new[] { "Id", "FechaCreacion", "FechaModificacion", "Nombre", "TipoMovimiento", "UsuarioId" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Salario", 1, null },
                    { 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Alimentación", 2, null }
                });
